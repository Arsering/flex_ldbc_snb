package org.ldbcoucil.snb.impls.workloads.graphscope.interactive;
...
import org.ldbcoucil.snb.impls.workloads.graphscope.GraphScopeDb;

public class GraphScopeInteractiveDb extends GraphScopeDb{
    @Override
