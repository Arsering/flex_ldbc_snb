  ...
  public:
    IC3(GraphDBSession &graph)
        : person_label_id_(graph.schema().get_vertex_label_id("PERSON")),
          ...
          commentx_label_id_(graph.schema().get_vertex_label_id("COMMENTX")),
          ...
          comment_creationDate_col_(graph.GetPropertyHandle(commentx_label_id_, "creationDate")),
    ...
    bool Query(Decoder &input, Encoder &output) override
    {
      ...
      auto commentx_hasCreator_person_out =
          txn.GetOutgoingSingleGraphView<grape::EmptyType>(
              commentx_label_id_, person_label_id_, hasCreator_label_id_);
      ...
      auto comment_isLocatedIn_place_in=txn.GetIncomingGraphView<grape::EmptyType>(place_label_id_,commentx_label_id_,  isLocatedIn_label_id_);
      ...
      //     place_label_id_, countryX, commentx_label_id_, isLocatedIn_label_id_);
      ...
      for (; commentex.is_valid(); commentex.next())
      {
        ...
        if (start_date <= creationDate && creationDate < end_date)
        {
          auto comment_oid=txn.GetVertexId(commentx_label_id_, commentex.get_neighbor());
          vid_t comment_id;
          txn.GetVertexIndex(comment_label_id_, comment_oid, comment_id);
          // auto item = comment_hasCreator_person_out.get_edge(commentex.get_neighbor());
          auto item=comment_hasCreator_person_out.get_edge(comment_id);
      ...
      //     place_label_id_, countryY, commentx_label_id_, isLocatedIn_label_id_);
      ...
      for (; commentey.is_valid(); commentey.next())
      {
        ...
        if (start_date <= creationDate && creationDate < end_date)
        {
          auto comment_oid=txn.GetVertexId(commentx_label_id_, commentey.get_neighbor());
          vid_t comment_id;
          txn.GetVertexIndex(comment_label_id_, comment_oid, comment_id);
          auto item=comment_hasCreator_person_out.get_edge(comment_id);
