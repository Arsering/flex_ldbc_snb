...
namespace gs
{
  ...
  public:
    ...
    bool Query(Decoder &input, Encoder &output) override
    {
      ...
      auto comment_isLocatedIn_place_out = txn.GetOutgoingSingleGraphView<grape::EmptyType>(comment_label_id_, place_label_id_, isLocatedIn_label_id_);

      for(auto v:friends){
        auto post_ie=post_hasCreator_person_in.get_edges(v);
