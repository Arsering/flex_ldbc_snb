...
class PERSON_IS : public AppBase {
public:
  PERSON_IS(GraphDBSession &graph)
...
extern "C"
{
  ...
  {
    gs::PERSON_IS *app = new gs::PERSON_IS(db);
    return static_cast<void *>(app);
  }

  void DeleteApp(void *app)
  {
    gs::PERSON_IS *casted = static_cast<gs::PERSON_IS *>(app);
    delete casted;
  }
}
